...
ecma_value_t ecma_op_create_regexp_object_from_bytecode (const re_compiled_code_t *bytecode_p);
...
void re_initialize_props (ecma_object_t *re_obj_p, const re_compiled_code_t *bytecode_p);
